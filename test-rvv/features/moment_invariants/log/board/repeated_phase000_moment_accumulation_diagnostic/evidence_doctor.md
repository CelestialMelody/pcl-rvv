...
- title：Moment invariants accumulation diagnostic repeated board summary
...
### 1. environment_metadata_missing — mi_accumulation_indexed
...
### 2. binary_identity_missing — mi_accumulation_indexed
