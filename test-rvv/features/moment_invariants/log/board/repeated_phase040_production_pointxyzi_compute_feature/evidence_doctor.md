...
- title：Moment invariants production PointXYZI computeFeature repeated board summary
...
### 1. environment_metadata_missing — mi_production_compute_feature_pointxyzi
...
### 2. binary_identity_missing — mi_production_compute_feature_pointxyzi
