# GASD public color compute profile repeated board summary

- run_label: `gasd_phase080_public_color_compute_repeated`
- expected_runs: `5`
- collected_runs: `5`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `public_gasd_color_compute` | 5 | 1.110x | 1.100x | 1.120x | 1.100x | 1.116x | 0/5 | 1.110x, 1.120x, 1.110x, 1.100x, 1.100x |
