...
- summary_path：log/board/phase060-pointxyzi-normal/repeated
- comparisons：1
...
### 1. environment_metadata_missing — public_ppf_compute_pointxyzi_normal
...
### 2. binary_identity_missing — public_ppf_compute_pointxyzi_normal
