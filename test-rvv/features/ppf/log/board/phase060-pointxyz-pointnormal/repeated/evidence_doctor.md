...
- summary_path：log/board/phase060-pointxyz-pointnormal/repeated
- comparisons：1
...
### 1. environment_metadata_missing — public_ppf_compute_pointxyz_pointnormal
...
### 2. binary_identity_missing — public_ppf_compute_pointxyz_pointnormal
