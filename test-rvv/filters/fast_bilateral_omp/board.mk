# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/filters/fast_bilateral_omp/Makefile）
# =============================================================================

REMOTE_BENCH_STD = bench_fast_bilateral_omp_std
REMOTE_BENCH_RVV = bench_fast_bilateral_omp_rvv
REMOTE_TEST      = test_fast_bilateral_omp_rvv

REMOTE_DIR        = /root/pcl-test/filters/fast_bilateral_omp
