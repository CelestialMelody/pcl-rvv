# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/filters/crop_box/Makefile）
# =============================================================================

REMOTE_BENCH_STD = bench_crop_box_std
REMOTE_BENCH_RVV = bench_crop_box_rvv
REMOTE_TEST      = test_crop_box_rvv

REMOTE_DIR        = /root/pcl-test/filters/crop_box
