# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/filters/voxel_grid_covariance/Makefile）
# =============================================================================

REMOTE_BENCH_STD = bench_voxel_grid_covariance_std
REMOTE_BENCH_RVV = bench_voxel_grid_covariance_rvv
REMOTE_TEST      = test_voxel_grid_covariance_rvv

REMOTE_DIR        = /root/pcl-test/filters/voxel_grid_covariance
