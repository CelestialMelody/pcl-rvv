# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/filters/shadowpoints/Makefile）
# =============================================================================

REMOTE_BENCH_STD = bench_shadowpoints_std
REMOTE_BENCH_RVV = bench_shadowpoints_rvv
REMOTE_TEST      = test_shadowpoints_rvv

REMOTE_DIR        = /root/pcl-test/filters/shadowpoints
