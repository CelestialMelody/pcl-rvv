#!/usr/bin/env python3
"""Summarize repeated lzf_image_io board bench logs.

本脚本读取 run*/run_bench_std.log 和 run*/run_bench_rvv.log，生成只含
summary（摘要）的 Markdown。raw log 仍留在 topic-local log/board 下，
默认不进入提交。
"""
...
def main() -> int:
    ...
    parser.add_argument("--title", default="lzf_image_io repeated board summary")
