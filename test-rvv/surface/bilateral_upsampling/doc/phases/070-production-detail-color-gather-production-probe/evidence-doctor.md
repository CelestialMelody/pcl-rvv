...
- title：surface/bilateral_upsampling production detail color-gather production probe
...
### 1. near_threshold_ba — bilateral upsampling production public PointXYZRGBA 180x120 w5 dense
