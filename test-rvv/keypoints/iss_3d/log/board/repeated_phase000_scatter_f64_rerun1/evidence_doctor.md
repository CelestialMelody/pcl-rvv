...
- title：ISS 3D scatter f64 diagnostic repeated board summary rerun1
- evidence_role：diagnostic
- summary_path：log/board/repeated_phase000_scatter_f64_rerun1/summary.md
- comparisons：3
- result：Errors=0，Warnings=1，Suggestions=6
...
### 1. group_outlier — scatter_indexed_tail_73

- observed_pattern：group=iss_3d_scatter_f64 的组内 median=1.66x；当前 case median=1.21x，偏离 27.0%。
