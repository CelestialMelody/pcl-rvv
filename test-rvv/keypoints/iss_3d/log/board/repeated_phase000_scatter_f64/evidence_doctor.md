...
- title：ISS 3D scatter f64 diagnostic repeated board summary
- evidence_role：diagnostic
- summary_path：log/board/repeated_phase000_scatter_f64/summary.md
- comparisons：3
- result：Errors=0，Warnings=3，Suggestions=6
...
### 1. ba_degradation_frequency — scatter_indexed_256

- observed_pattern：B/A values=0.691x, 1.63x, 1.68x, 1.67x, 1.62x；1/5 低于 1。
...
### 2. long_tail_or_variance — scatter_indexed_256

- observed_pattern：min=0.691x, median=1.63x, max=1.68x，max/min=2.44。
...
### 3. group_outlier — scatter_indexed_tail_73

- observed_pattern：group=iss_3d_scatter_f64 的组内 median=1.63x；当前 case median=1.23x，偏离 24.6%。
...
### 1. environment_metadata_missing — scatter_contiguous_256
...
### 2. binary_identity_missing — scatter_contiguous_256
...
### 3. environment_metadata_missing — scatter_indexed_256
...
### 4. binary_identity_missing — scatter_indexed_256
...
### 5. environment_metadata_missing — scatter_indexed_tail_73
...
### 6. binary_identity_missing — scatter_indexed_tail_73
