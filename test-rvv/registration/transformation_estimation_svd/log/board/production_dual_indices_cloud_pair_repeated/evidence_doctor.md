...
- title：transformation_estimation_svd production direct dual-indices-cloud-pair board repeated
- evidence_role：production_direct
- summary_path：log/board/production_dual_indices_cloud_pair_repeated/summary.md
- comparisons：3
...
### 1. long_tail_or_variance — production direct dual-indices-cloud-pair 256K

- observed_pattern：min=4.96x, median=5.96x, max=6.2x，max/min=1.25。
