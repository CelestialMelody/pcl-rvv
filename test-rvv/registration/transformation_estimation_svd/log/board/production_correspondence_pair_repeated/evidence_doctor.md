...
- title：transformation_estimation_svd production direct correspondence-pair board repeated
- evidence_role：production_direct
- summary_path：log/board/production_correspondence_pair_repeated/summary.md
- comparisons：3
...
### 1. long_tail_or_variance — production direct correspondence-pair 256K

- observed_pattern：min=7.01x, median=7.87x, max=8.3x，max/min=1.19。
