...
- summary_path：log/board/fused_full_cloud_repeated/summary.md
- comparisons：9
...
### 1. production_name_without_role — public build sanity ordered-cloud-pair 4K
...
### 2. production_name_without_role — public build sanity ordered-cloud-pair 64K
...
### 3. production_name_without_role — public build sanity ordered-cloud-pair 256K
...
### 4. group_outlier — mixed-boundary public baseline vs fused RVV ordered-cloud-pair 4K

- observed_pattern：group=tesvd_public_vs_fused_rvv 的组内 median=26.4x；当前 case median=16.2x，偏离 38.6%。
