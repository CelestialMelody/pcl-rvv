...
- run_label：`production_public_row_sources_repeated`
...
- manifest（默认本地证据清单）：`log/board/production_public_row_sources_repeated/evidence_manifest.json`
- Evidence Doctor：`log/board/production_public_row_sources_repeated/evidence_doctor.md`
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| 4K | `3.291, 3.270, 3.378, 3.246, 3.302` | 3.291 | 3.246 | 3.378 | `positive` | same |
| 64K | `3.634, 3.640, 3.641, 3.621, 3.623` | 3.634 | 3.621 | 3.641 | `positive` | same |
| 256K | `3.639, 3.658, 3.618, 3.632, 3.637` | 3.637 | 3.618 | 3.658 | `positive` | same |
