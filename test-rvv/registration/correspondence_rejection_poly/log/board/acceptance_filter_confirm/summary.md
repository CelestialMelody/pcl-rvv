...
- run_label: `acceptance_filter_confirm`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| accept-rate filter candidate 256K | `accept_rate_filter` | 262144 | 5 | 0.996x | 1.018x | 1.043x | 1.012x, 1.023x, 1.043x, 1.018x, 0.996x | 1/5 | match |
| accept-rate filter candidate 64K | `accept_rate_filter` | 65536 | 5 | 1.059x | 1.063x | 1.076x | 1.059x, 1.076x, 1.064x, 1.063x, 1.062x | 0/5 | match |
