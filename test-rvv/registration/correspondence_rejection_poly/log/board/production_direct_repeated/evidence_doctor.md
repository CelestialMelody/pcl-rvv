...
- title：correspondence_rejection_poly board repeated production_direct_repeated
- evidence_role：strict_ab
- summary_path：test-rvv/registration/correspondence_rejection_poly/log/board/production_direct_repeated/summary.md
- comparisons：2
