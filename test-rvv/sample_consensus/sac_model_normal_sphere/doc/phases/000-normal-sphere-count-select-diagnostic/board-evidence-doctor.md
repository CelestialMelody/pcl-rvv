...
- title：sac_model_normal_sphere Phase 000 board smoke manifest
- evidence_role：production_shaped_diagnostic
- summary_path：test-rvv/sample_consensus/sac_model_normal_sphere/doc/phases/000-normal-sphere-count-select-diagnostic/board-evidence-summary.md
- comparisons：6
...
### 2. low_run_count — PointXYZ diagnostic candidate countWithinDistance
...
### 3. low_run_count — PointXYZ diagnostic candidate getDistancesToModel
...
### 4. low_run_count — PointXYZI diagnostic candidate selectWithinDistance
...
### 5. low_run_count — PointXYZI diagnostic candidate countWithinDistance
...
### 6. low_run_count — PointXYZI diagnostic candidate getDistancesToModel
