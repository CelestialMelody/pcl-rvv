...
- title：sac_model_stick Phase 000 repeated board summary
- evidence_role：production_shaped_diagnostic
- summary_path：test-rvv/sample_consensus/sac_model_stick/doc/phases/000-stick-count-diagnostic/repeated-evidence-manifest.json
- comparisons：2
...
### 1. ba_degradation_frequency — sac_model_stick public countWithinDistance PointXYZ 65536

- observed_pattern：B/A values=1.02x, 1x, 1x, 1.01x, 1.01x；1/5 低于 1。
...
### 1. near_threshold_ba — sac_model_stick public countWithinDistance PointXYZ 65536
