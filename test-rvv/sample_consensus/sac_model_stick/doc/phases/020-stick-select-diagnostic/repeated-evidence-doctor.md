...
- title：sac_model_stick Phase 020 repeated board summary
- evidence_role：production_shaped_diagnostic
- summary_path：test-rvv/sample_consensus/sac_model_stick/doc/phases/020-stick-select-diagnostic/repeated-evidence-manifest.json
- comparisons：2
...
### 1. ba_degradation_frequency — sac_model_stick public selectWithinDistance PointXYZ 65536

- observed_pattern：B/A values=1.01x, 0.983x, 1x, 1x, 1.01x；1/5 低于 1。
...
### 1. near_threshold_ba — sac_model_stick public selectWithinDistance PointXYZ 65536
