...
- title：sac_model_circle3d Phase 020 PointXYZRGB select production repeated board summary
- evidence_role：production-public
- summary_path：test-rvv/sample_consensus/sac_model_circle3d/doc/phases/020-select-point-type-expansion/select-xyzrgb-repeated-evidence-manifest.json
- comparisons：1
...
### 1. ba_degradation_frequency — sac_model_circle3d selectWithinDistance production public Std/RVV PointXYZRGB 65536

- observed_pattern：B/A values=0.888x, 0.888x, 0.892x, 0.886x, 0.887x；5/5 低于 1。
