...
- title：sac_model_circle3d Phase 020 PointXYZRGBA select production repeated board summary
- evidence_role：production-public
- summary_path：test-rvv/sample_consensus/sac_model_circle3d/doc/phases/020-select-point-type-expansion/select-xyzrgba-repeated-evidence-manifest.json
- comparisons：1
...
### 1. ba_degradation_frequency — sac_model_circle3d selectWithinDistance production public Std/RVV PointXYZRGBA 65536

- observed_pattern：B/A values=0.889x, 0.875x, 0.906x, 0.853x, 0.891x；5/5 低于 1。
