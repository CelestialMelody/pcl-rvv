...
- summary_path：test-rvv/recognition/linemod_template_scoring/doc/phases/020-accumulation-bench-boundary-ablation/accumulation-ablation-repeated-summary.md
- comparisons：1
...
### 1. ba_degradation_frequency — LINEMOD score accumulation mem_size=4096 nr_maps=96

- observed_pattern：B/A values=0.825x, 0.882x, 0.889x, 0.858x, 0.862x；5/5 低于 1。
