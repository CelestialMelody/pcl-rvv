...
- title：QuantizableModality shared spread RVV production-detail repeated board summary
- evidence_role：production_detail
- summary_path：log/board/repeated_phase000_shared_spread_rvv/summary.md
- comparisons：2
...
### 1. environment_metadata_missing — shared_spread_320x240
...
### 2. binary_identity_missing — shared_spread_320x240
...
### 3. environment_metadata_missing — shared_spread_641x481_tail
...
### 4. binary_identity_missing — shared_spread_641x481_tail
