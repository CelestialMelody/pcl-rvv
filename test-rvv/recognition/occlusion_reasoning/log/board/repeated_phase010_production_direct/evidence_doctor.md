...
- title：Occlusion reasoning ZBuffering production-direct repeated board summary
...
### 1. environment_metadata_missing — production_filter_indices_projection_mask_compress
