...
- summary_path：test-rvv/recognition/hough_3d/log/board/repeated_phase010_production_direct/summary.md
- comparisons：1
...
### 1. ba_degradation_frequency — hough_3d_production_hough_voting

- observed_pattern：B/A values=0.988x, 0.993x, 0.996x, 0.995x, 0.996x；5/5 低于 1。
