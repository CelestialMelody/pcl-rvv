...
- summary_path：test-rvv/recognition/hough_3d/log/board/repeated_phase030_default_distance_weight/summary.md
- comparisons：1
...
### 1. ba_degradation_frequency — hough_3d_default_distance_weight_hough_voting

- observed_pattern：B/A values=1x, 1.01x, 1.01x, 0.997x, 1.01x；1/5 低于 1。
...
### 1. near_threshold_ba — hough_3d_default_distance_weight_hough_voting
