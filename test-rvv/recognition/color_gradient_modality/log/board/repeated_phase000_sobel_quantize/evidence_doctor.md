...
- title：CGM Sobel+quantize production-shaped diagnostic repeated board summary
- evidence_role：production_shaped_diagnostic
- summary_path：log/board/repeated_phase000_sobel_quantize/summary.md
- comparisons：2
...
### 1. environment_metadata_missing — sobel_quantize_320x240
...
### 2. binary_identity_missing — sobel_quantize_320x240
...
### 3. environment_metadata_missing — sobel_quantize_641x481_tail
...
### 4. binary_identity_missing — sobel_quantize_641x481_tail
