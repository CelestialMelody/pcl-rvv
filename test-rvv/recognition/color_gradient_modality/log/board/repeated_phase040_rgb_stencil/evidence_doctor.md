...
- title：CGM RGB stencil RVV ablation repeated board summary
- evidence_role：production_shaped_diagnostic
- summary_path：log/board/repeated_phase040_rgb_stencil/summary.md
- comparisons：4
...
### 1. environment_metadata_missing — full_chain_320x240
...
### 2. binary_identity_missing — full_chain_320x240
...
### 3. environment_metadata_missing — full_chain_641x481_tail
...
### 4. binary_identity_missing — full_chain_641x481_tail
...
### 5. environment_metadata_missing — full_chain_stencil_320x240
...
### 6. binary_identity_missing — full_chain_stencil_320x240
...
### 7. environment_metadata_missing — full_chain_stencil_641x481_tail
...
### 8. binary_identity_missing — full_chain_stencil_641x481_tail
