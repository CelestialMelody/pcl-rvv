...
- title：SNM depth-to-normal quantize production-shaped diagnostic repeated board summary
- evidence_role：production_shaped_diagnostic
- summary_path：log/board/repeated_phase000_depth_quantize/summary.md
- comparisons：2
...
### 1. environment_metadata_missing — depth_quantize_320x240
...
### 2. binary_identity_missing — depth_quantize_320x240
...
### 3. environment_metadata_missing — depth_quantize_641x481_tail
...
### 4. binary_identity_missing — depth_quantize_641x481_tail
