...
- summary_path：log/board/repeated-production-xyzinormal/summary.md
- comparisons：1
...
- observed_pattern：B/A values=1.45x, 0.994x, 1.03x, 1.11x, 1.09x；1/5 低于 1。
...
### 2. long_tail_or_variance — eppd single polygon full-scan production indices=dense point-type=xyzinormal

- observed_pattern：min=0.994x, median=1.09x, max=1.45x，max/min=1.46。
