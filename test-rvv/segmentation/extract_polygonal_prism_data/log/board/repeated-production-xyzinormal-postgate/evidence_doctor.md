...
- summary_path：log/board/repeated-production-xyzinormal-postgate/summary.md
- comparisons：1
...
- observed_pattern：B/A values=1.02x, 0.993x, 1x, 1.03x, 1x；1/5 低于 1。
...
### 1. near_threshold_ba — eppd single polygon full-scan production indices=dense point-type=xyzinormal
