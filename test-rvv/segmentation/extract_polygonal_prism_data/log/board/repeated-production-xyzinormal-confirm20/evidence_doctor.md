...
- title：EPPD full-scan single-polygon repeated board (production_public, dense_ordered_indices)
- evidence_role：production_public
- summary_path：log/board/repeated-production-xyzinormal-confirm20/summary.md
- comparisons：1
...
### 1. ba_degradation_frequency — eppd single polygon full-scan production indices=dense point-type=xyzinormal

- observed_pattern：B/A values=1.08x, 1.47x, 1.09x, 1.11x, 1.46x, 0.885x, 1.06x, 0.89x, 1.16x, 1.17x, 1.31x, 1.06x, 1.54x, 0.927x, 1.2x, 1.12x, 1.34x, 0.879x, 0.958x, 1.44x；5/20 低于 1。
...
### 1. long_tail_or_variance — eppd single polygon full-scan production indices=dense point-type=xyzinormal

- observed_pattern：min=0.879x, median=1.12x, max=1.54x，max/min=1.75。
