# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/common/transforms/Makefile 的 deploy_* 目标）
# =============================================================================

REMOTE_BENCH_STD = bench_transforms_std
REMOTE_BENCH_RVV = bench_transforms_rvv
REMOTE_TEST      = test_transforms

REMOTE_DIR        = /root/pcl-test/common/transforms
