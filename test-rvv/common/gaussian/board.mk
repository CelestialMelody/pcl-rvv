# =============================================================================
# 板卡侧运行 Makefile（配套 test-rvv/common/gaussian/Makefile 的 deploy_* 目标）
# =============================================================================

REMOTE_BENCH_STD = bench_gaussian_std
REMOTE_BENCH_RVV = bench_gaussian_rvv
REMOTE_TEST      = test_gaussian

REMOTE_DIR        = /root/pcl-test/common/gaussian
