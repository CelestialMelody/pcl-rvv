...
- 函数评估队列完成或已完成主题反哺排序：使用 [references/templates/retained-candidate-rescreen-template.md](references/templates/retained-candidate-rescreen-template.md)。语义是复筛函数评估队列中的保留候选。
...
- 筛选文档位置；
- 文件候选筛选的 high/mid/low、函数评估队列三类队列，或保留候选复筛两类队列数量；
- 第一条未完成主题；
