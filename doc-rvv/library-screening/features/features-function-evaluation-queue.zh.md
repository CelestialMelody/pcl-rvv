...
| 2 | NormalEstimation covariance helper | `impl/normal_3d.hpp` | `computePointNormal` 中邻域 centroid/covariance 累加 | 未启动 | 复用 `normal_3d` benchmark，先隔离 search/Eigen 与 helper 成本 |
